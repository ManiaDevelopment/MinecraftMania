...
public class PrimedTnt extends Entity {
	...
	public PrimedTnt(Level var1, float var2, float var3, float var4) {
		...
		this.yd = 0.2F;
		this.zd = -MathHelper.b(var5 * 3.1415927F / 180.0F) * 0.02F;
	...
	public void hurt(Entity var1, int var2) {
		if(!this.removed) {
			...
			if(var1 instanceof Player) {
				this.remove();
				this.level.addEntity(new Item(this.level, this.x, this.y, this.z, Block.X.ac));
			}
	...
	public void tick() {
		...
		if(!this.defused) {
			if(this.life-- > 0) {
				this.level.particleEngine$13e306ae.a(new SmokeParticle(this.level, this.x, this.y + 0.6F, this.z));
			} else {
				this.remove();
				//this = this;
				...
				for(int var3 = 0; var3 < 100; ++var3) {
					...
					float var7 = MathHelper.c(var4 * var4 + var5 * var5 + var6 * var6);
					float var8 = var4 / var7 / var7;
					float var9 = var5 / var7 / var7;
					var7 = var6 / var7 / var7;
					this.level.particleEngine$13e306ae.a(new TerrainParticle(this.level, this.x + var4, this.y + var5, this.z + var6, var8, var9, var7, Block.X));
				}
	...
	public void playerTouch(Entity var1) {
		if(this.defused) {
			Player var2;
			if((var2 = (Player)var1).addResource(Block.X.ac)) {
	...
	public void render$2a8c5a(TextureManager var1, float var2) {
		...
		GL11.glPushMatrix();
		ShapeRender var5 = ShapeRender.a;
		Block.X.b(var5);
		GL11.glDisable(3553);
		GL11.glDisable(2896);
