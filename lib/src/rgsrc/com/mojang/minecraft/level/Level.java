...
import com.mojang.minecraft.sound.c;
import com.mojang.minecraft.sound.h;
import com.mojang.minecraft.sound.n;
...
public class Level implements Serializable {
   ...
   public transient ParticleManager particleEngine$13e306ae;
   ...
   public void setData(int var1, int var2, int var3, byte[] var4) {
      ...
      for(var1 = 0; var1 < this.a.size(); ++var1) {
         ((LevelRenderer)this.a.get(var1)).a();
      }
      ...
      for(int var5 = var1; var5 < var1 + var3; ++var5) {
         for(int var6 = var2; var6 < var2 + var4; ++var6) {
            ...
            if(var7 != var8) {
               ...
               for(var8 = 0; var8 < this.a.size(); ++var8) {
                  ((LevelRenderer)this.a.get(var8)).a(var5 - 1, var9 - 1, var6 - 1, var5 + 1, var7 + 1, var6 + 1);
               }
            }
         }
      }
   ...
   public void addListener$74652038(LevelRenderer var1) {
      this.a.add(var1);
   }

   public void finalize() {}

   public void removeListener$74652038(LevelRenderer var1) {
      this.a.remove(var1);
   }

   public boolean isLightBlocker(int var1, int var2, int var3) {
      Block var4;
      return (var4 = Block.b[this.getTile(var1, var2, var3)]) == null?false:var4.b();
   }
         ...
         for(int var9 = var5; var9 < var6; ++var9) {
            for(int var10 = var7; var10 < var8; ++var10) {
               ...
               if(var3 >= 0 && var9 >= 0 && var10 >= 0 && var3 < this.width && var9 < this.depth && var10 < this.height) {
                  Block var12;
                  if((var12 = Block.b[this.getTile(var3, var9, var10)]) != null && (var11 = var12.b(var3, var9, var10)) != null && var1.intersectsInner(var11)) {
                     var2.add(var11);
                  }
               } else if((var3 < 0 || var9 < 0 || var10 < 0 || var3 >= this.width || var10 >= this.height) && (var11 = Block.k.b(var3, var9, var10)) != null && var1.intersectsInner(var11)) {
                  var2.add(var11);
               }
            }
         }
   ...
   public boolean netSetTileNoNeighborChange(int var1, int var2, int var3, int var4) {
      if(var1 >= 0 && var2 >= 0 && var3 >= 0 && var1 < this.width && var2 < this.depth && var3 < this.height) {
         if(var4 == this.blocks[(var2 * this.height + var3) * this.width + var1]) {
            ...
            if(var5 != 0) {
               Block.b[var5].d(this, var1, var2, var3);
            }

            if(var4 != 0) {
               Block.b[var4].c(this, var1, var2, var3);
            }

            this.calcLightDepths(var1, var3, 1, 1);

            for(var4 = 0; var4 < this.a.size(); ++var4) {
               ((LevelRenderer)this.a.get(var4)).a(var1 - 1, var2 - 1, var3 - 1, var1 + 1, var2 + 1, var3 + 1);
            }
   ...
   private void a(int var1, int var2, int var3, int var4) {
      if(var1 >= 0 && var2 >= 0 && var3 >= 0 && var1 < this.width && var2 < this.depth && var3 < this.height) {
         Block var5;
         if((var5 = Block.b[this.blocks[(var2 * this.height + var3) * this.width + var1]]) != null) {
   ...
   public boolean isSolidTile(int var1, int var2, int var3) {
      Block var4;
      return (var4 = Block.b[this.getTile(var1, var2, var3)]) == null?false:var4.c();
   }
   ...
   public void tick() {
         ...
         for(var7 = 0; var7 < var6; ++var7) {
            ...
            if((var8 = (NextTickListEntry)this.d.remove(0)).ticks > 0) {
               ...
               if(this.a(var8.x, var8.y, var8.z) && (var9 = this.blocks[(var8.y * this.height + var8.z) * this.width + var8.x]) == var8.block && var9 > 0) {
                  Block.b[var9].a(this, var8.x, var8.y, var8.z, this.random);
               }
            }
         }
      }
      ...
      for(var7 = 0; var7 < var6; ++var7) {
         ...
         if(Block.c[var11]) {
            Block.b[var11].a(this, var13, var12, var10, this.random);
         }
      }
      ...
      for(int var10 = var2; var10 < var3; ++var10) {
         for(var2 = var4; var2 < var5; ++var2) {
            for(int var8 = var6; var8 < var7; ++var8) {
               Block var9;
               if((var9 = Block.b[this.getTile(var10, var2, var8)]) != null && var9.d() != LiquidType.a) {
                  return true;
               }
            }
         }
      ...
      for(int var11 = var3; var11 < var4; ++var11) {
         for(var3 = var5; var3 < var6; ++var3) {
            for(int var9 = var7; var9 < var8; ++var9) {
               Block var10;
               if((var10 = Block.b[this.getTile(var11, var3, var9)]) != null && var10.d() == var2) {
                  return true;
               }
            }
         }
   ...
   private boolean a(float var1, float var2, float var3) {
      int var4;
      return (var4 = this.getTile((int)var1, (int)var2, (int)var3)) > 0 && Block.b[var4].c();
   }

   public int getHighestTile(int var1, int var2) {
      int var3;
      for(var3 = this.depth; (this.getTile(var1, var3 - 1, var2) == 0 || Block.b[this.getTile(var1, var3 - 1, var2)].d() != LiquidType.a) && var3 > 0; --var3) {
         ;
      }
      ...
      for(int var9 = var5 - 6; var9 <= var5 + 6; ++var9) {
         for(int var10 = var6 - 6; var10 <= var6 + 6; ++var10) {
            if(this.a(var9, var14, var10) && !this.isSolidTile(var9, var14, var10)) {
               ...
               var11 = MathHelper.c(var11 * var11 + 4.0F + var12 * var12);
               var11 = 1.0F / var11;
               if(var13 > 1.0F) {
                  var11 = 0.0F;
               }
   ...
   public float getCaveness(Entity var1) {
      float var2 = MathHelper.b(-var1.yRot * 0.017453292F + 3.1415927F);
      float var3 = MathHelper.a(-var1.yRot * 0.017453292F + 3.1415927F);
   ...
   public LiquidType getLiquid(int var1, int var2, int var3) {
      int var4;
      return (var4 = this.getTile(var1, var2, var3)) == 0?LiquidType.a:Block.b[var4].d();
   }

   public boolean isWater(int var1, int var2, int var3) {
      int var4;
      return (var4 = this.getTile(var1, var2, var3)) > 0 && Block.b[var4].d() == LiquidType.b;
   }
   ...
   public MovingObjectPosition clip(Vec3D var1, Vec3D var2) {
      if(!Float.isNaN(var1.a) && !Float.isNaN(var1.b) && !Float.isNaN(var1.c)) {
         if(!Float.isNaN(var2.a) && !Float.isNaN(var2.b) && !Float.isNaN(var2.c)) {
            int var3 = (int)Math.floor((double)var2.a);
            int var4 = (int)Math.floor((double)var2.b);
            int var5 = (int)Math.floor((double)var2.c);
            int var6 = (int)Math.floor((double)var1.a);
            int var7 = (int)Math.floor((double)var1.b);
            int var8 = (int)Math.floor((double)var1.c);
            int var9 = 20;
            ...
            while(var9-- >= 0) {
               ...
               float var14 = 999.0F;
               float var15 = 999.0F;
               float var16 = var2.a - var1.a;
               float var17 = var2.b - var1.b;
               float var18 = var2.c - var1.c;
               if(var10 != 999.0F) {
                  var13 = (var10 - var1.a) / var16;
               }

               if(var11 != 999.0F) {
                  var14 = (var11 - var1.b) / var17;
               }

               if(var12 != 999.0F) {
                  var15 = (var12 - var1.c) / var18;
               }
               ...
               Vec3D var20;
               var6 = (int)((var20 = new Vec3D(var1.a, var1.b, var1.c)).a = (float)Math.floor((double)var1.a));
               if(var24 == 5) {
                  --var6;
                  ++var20.a;
               }

               var7 = (int)(var20.b = (float)Math.floor((double)var1.b));
               if(var24 == 1) {
                  --var7;
                  ++var20.b;
               }

               var8 = (int)(var20.c = (float)Math.floor((double)var1.c));
               if(var24 == 3) {
                  --var8;
                  ++var20.c;
               }
               ...
               Block var21 = Block.b[var22];
               if(var22 > 0 && var21.d() == LiquidType.a) {
                  MovingObjectPosition var23;
                  if(var21.a()) {
                     if((var23 = var21.a(var6, var7, var8, var1, var2)) != null) {
                        return var23;
                     }
                  } else if((var23 = var21.a(var6, var7, var8, var1, var2)) != null) {
                     return var23;
                  }
               }
            }
   ...
   public void playSound(String var1, Entity var2, float var3, float var4) {
      if(this.rendererContext$5cd64a7f != null) {
         Minecraft var5;
         if((var5 = this.rendererContext$5cd64a7f).audioPlayer == null || !var5.settings.b) {
            return;
         }

         h var6;
         if(var2.distanceToSqr(var5.player) < 1024.0F && (var6 = var5.audioManager.a(var1, var3, var4)) != null) {
            var5.audioPlayer.a(var6, new c(var2, var5.player));
         }
      }
   ...
   public void playSound(String var1, float var2, float var3, float var4, float var5, float var6) {
      if(this.rendererContext$5cd64a7f != null) {
         Minecraft var7;
         if((var7 = this.rendererContext$5cd64a7f).audioPlayer == null || !var7.settings.b) {
            return;
         }

         h var8;
         if((var8 = var7.audioManager.a(var1, var5, var6)) != null) {
            var7.audioPlayer.a(var8, new n(var2, var3, var4, var7.player));
         }
      }
   ...
   public boolean maybeGrowTree(int var1, int var2, int var3) {
      ...
      if(!var5) {
         return false;
      } else if((this.blocks[((var2 - 1) * this.height + var3) * this.width + var1] & 255) == Block.f.ac && var2 < this.depth - var4 - 1) {
         this.setTile(var1, var2 - 1, var3, Block.g.ac);
            ...
            for(int var10 = var1 - var9; var10 <= var1 + var9; ++var10) {
               ...
               for(var6 = var3 - var9; var6 <= var3 + var9; ++var6) {
                  ...
                  if(Math.abs(var12) != var9 || Math.abs(var11) != var9 || this.random.nextInt(2) != 0 && var8 != 0) {
                     this.setTile(var10, var13, var6, Block.v.ac);
                  }
               }
            }
         }
         ...
         for(var13 = 0; var13 < var4; ++var13) {
            this.setTile(var1, var2 + var13, var3, Block.u.ac);
         }
      ...
      for(int var12 = var6; var12 < var7; ++var12) {
         for(var13 = var9 - 1; var13 >= var8; --var13) {
            for(int var14 = var10; var14 < var11; ++var14) {
               ...
               int var19;
               if(var12 >= 0 && var13 >= 0 && var14 >= 0 && var12 < this.width && var13 < this.depth && var14 < this.height && var15 * var15 + var16 * var16 + var17 * var17 < var5 * var5 && (var19 = this.getTile(var12, var13, var14)) > 0 && Block.b[var19].i()) {
                  Block.b[var19].a(this, var12, var13, var14, 0.3F);
                  this.setTile(var12, var13, var14, 0);
                  Block.b[var19].f(this, var12, var13, var14);
               }
            }
         }
      }
