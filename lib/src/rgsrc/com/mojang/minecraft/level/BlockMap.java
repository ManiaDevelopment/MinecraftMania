...
import com.mojang.minecraft.level.e;
...
public class BlockMap implements Serializable {
   ...
   private int depth;
   private int height;
   private BlockMap$Slot slot = new BlockMap$Slot(this, (e)null);
   private BlockMap$Slot slot2 = new BlockMap$Slot(this, (e)null);
   ...
   public void render$7127a881(Vec3D var1, ClippingHelper var2, TextureManager var3, float var4) {
               ...
               if((var12 = this.entityGrid[(var11 * this.depth + var8) * this.width + var5]).size() != 0) {
                  ...
                  if(var2.a(var6, var9, var13, var7, var10, var14)) {
                     ...
                     while(true) {
                        ...
                        if(var19.a[var20][0] * var18 + var19.a[var20][1] * var13 + var19.a[var20][2] * var14 + var19.a[var20][3] <= 0.0F) {
                           var10000 = false;
                           break;
                        }

                        if(var19.a[var20][0] * var15 + var19.a[var20][1] * var13 + var19.a[var20][2] * var14 + var19.a[var20][3] <= 0.0F) {
                           var10000 = false;
                           break;
                        }

                        if(var19.a[var20][0] * var18 + var19.a[var20][1] * var17 + var19.a[var20][2] * var14 + var19.a[var20][3] <= 0.0F) {
                           var10000 = false;
                           break;
                        }

                        if(var19.a[var20][0] * var15 + var19.a[var20][1] * var17 + var19.a[var20][2] * var14 + var19.a[var20][3] <= 0.0F) {
                           var10000 = false;
                           break;
                        }

                        if(var19.a[var20][0] * var18 + var19.a[var20][1] * var13 + var19.a[var20][2] * var16 + var19.a[var20][3] <= 0.0F) {
                           var10000 = false;
                           break;
                        }

                        if(var19.a[var20][0] * var15 + var19.a[var20][1] * var13 + var19.a[var20][2] * var16 + var19.a[var20][3] <= 0.0F) {
                           var10000 = false;
                           break;
                        }

                        if(var19.a[var20][0] * var18 + var19.a[var20][1] * var17 + var19.a[var20][2] * var16 + var19.a[var20][3] <= 0.0F) {
                           var10000 = false;
                           break;
                        }

                        if(var19.a[var20][0] * var15 + var19.a[var20][1] * var17 + var19.a[var20][2] * var16 + var19.a[var20][3] <= 0.0F) {
                           var10000 = false;
                           break;
                        }
                     ...
                     for(int var23 = 0; var23 < var12.size(); ++var23) {
                        ...
                        if((var22 = (Entity)var12.get(var23)).shouldRender(var1)) {
                           if(!var21) {
                              AABB var24 = var22.bb;
                              if(!var2.a(var24.x0, var24.y0, var24.z0, var24.x1, var24.y1, var24.z1)) {
                                 continue;
                              }
                           }

                           var22.render$2a8c5a(var3, var4);
                        }
                     }
                  }
               }
