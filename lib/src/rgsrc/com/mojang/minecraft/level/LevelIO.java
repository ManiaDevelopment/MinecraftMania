...
public final class LevelIO {
   ...
   public final boolean a(Level var1, File var2) {
      try {
         FileOutputStream var5 = new FileOutputStream(var2);
         a(var1, (OutputStream)var5);
         var5.close();
         return true;
      } catch (Exception var4) {
         var4.printStackTrace();
         if(this.progressBar != null) {
            this.progressBar.b("Failed!");
         }
   ...
   public final Level a(File var1) {
      try {
         FileInputStream var5 = new FileInputStream(var1);
         Level var2 = this.a((InputStream)var5);
         var5.close();
         return var2;
      } catch (Exception var4) {
         var4.printStackTrace();
   ...
   public final boolean a(Level var1, String var2, String var3, String var4, String var5, int var6) {
      if(var4 == null) {
         var4 = "";
      }

      if(this.progressBar != null && this.progressBar != null) {
         this.progressBar.a("Saving level");
      }

      try {
         if(this.progressBar != null && this.progressBar != null) {
            this.progressBar.b("Compressing..");
         }

         ByteArrayOutputStream var7 = new ByteArrayOutputStream();
         a(var1, (OutputStream)var7);
         var7.close();
         byte[] var10 = var7.toByteArray();
         if(this.progressBar != null && this.progressBar != null) {
            this.progressBar.b("Connecting..");
         }
         ...
         if(!(var11 = new BufferedReader(new InputStreamReader(var12.getInputStream()))).readLine().equalsIgnoreCase("ok")) {
            if(this.progressBar != null) {
               this.progressBar.b("Failed: " + var11.readLine());
            }
   ...
   public final Level a(String var1, String var2, int var3) {
      if(this.progressBar != null) {
         this.progressBar.a("Loading level");
      }
