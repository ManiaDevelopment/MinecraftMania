...
public final class MobSpawner {
   ...
   public final int a(int var1, Entity var2, ProgressBarDisplay var3) {
      int var4 = 0;

      for(int var5 = 0; var5 < var1; ++var5) {
         if(var3 != null) {
            var3.a(var5 * 100 / (var1 - 1));
         }
         ...
         if(!this.level.isSolidTile(var7, var8, var9) && this.level.getLiquid(var7, var8, var9) == LiquidType.a && (!this.level.isLit(var7, var8, var9) || this.level.random.nextInt(5) == 0)) {
