...
public class NetworkPlayer extends HumanoidMob {
   ...
   int tickCount = 0;
   private TextureManager textures$7a7c7041;
   ...
   public void bindTexture$4211e026(TextureManager var1) {
      this.textures$7a7c7041 = var1;
      if(this.newTexture != null) {
         ...
         this.a = var1.b(this.newTexture);
         this.newTexture = null;
      }

      if(this.a < 0) {
         GL11.glBindTexture(3553, var1.a("/char.png"));
      } else {
   ...
   public void renderHover(TextureManager var1, float var2) {
      ...
      GL11.glTranslatef((float)(-var3.a(this.displayName)) / 2.0F, 0.0F, 0.0F);
      GL11.glNormal3f(1.0F, -1.0F, 1.0F);
      GL11.glDisable(2896);
      GL11.glDisable(16384);
      if(this.name.equalsIgnoreCase("Notch")) {
         var3.b(this.displayName, 0, 0, 16776960);
      } else {
         var3.b(this.displayName, 0, 0, 16777215);
      }
   ...
   public void clear() {
      if(this.a >= 0 && this.textures$7a7c7041 != null) {
         TextureManager var10000 = this.textures$7a7c7041;
         int var1 = this.a;
         TextureManager var2 = this.textures$7a7c7041;
         var10000.b.remove(Integer.valueOf(var1));
         var2.c.clear();
         var2.c.put(var1);
         var2.c.flip();
         GL11.glDeleteTextures(var2.c);
      }
