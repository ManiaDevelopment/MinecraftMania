...
public class Mob extends Entity {
   ...
   protected void bindTexture$4211e026(TextureManager var1) {
      this.textureId = var1.a(this.textureName);
      ...
      if(this.modelName != null) {
         ...
         if((var11 = (float)this.hurtTime - var2) > 0.0F || this.health <= 0) {
            if(var11 < 0.0F) {
               ...
               var11 = MathHelper.a((var11 /= (float)this.hurtDuration) * var11 * var11 * var11 * 3.1415927F) * 14.0F;
            }
         ...
         GL11.glScalef(-1.0F, 1.0F, 1.0F);
         modelCache.a(this.modelName).a = var3 / 5.0F;
         this.bindTexture$4211e026(var1);
         this.renderModel$f1c6c5a(var1, var8, var2, var5, var6, var7, var9);
   ...
   public void renderModel$f1c6c5a(TextureManager var1, float var2, float var3, float var4, float var5, float var6, float var7) {
      modelCache.a(this.modelName).a(var2, var4, (float)this.tickCount + var3, var5, var6, var7);
   }
