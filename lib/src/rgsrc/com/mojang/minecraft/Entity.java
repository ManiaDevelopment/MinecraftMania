...
public abstract class Entity implements Serializable {
   ...
   public void setPos(PositionUpdate var1) {
      if(var1.g) {
         this.setPos(var1.a, var1.b, var1.c);
      } else {
         this.setPos(this.x, this.y, this.z);
      }

      if(var1.f) {
         this.setRot(var1.d, var1.e);
      } else {
   ...
   public void move(float var1, float var2, float var3) {
      if(this.noPhysics) {
         ...
         var18 = this.x - var4;
         var17 = this.z - var5;
         this.walkDist = (float)((double)this.walkDist + (double)MathHelper.c(var18 * var18 + var17 * var17) * 0.6D);
         if(this.makeStepSound) {
            ...
            if(this.walkDist > (float)this.nextStep && var19 > 0) {
               ...
               if((var20 = Block.b[var19].ad) != Tile$SoundType.none) {
   ...
   public boolean isInWater() {
      return this.level.containsLiquid(this.bb.grow(0.0F, -0.4F, 0.0F), LiquidType.b);
   }

   public boolean isUnderWater() {
      int var1;
      return (var1 = this.level.getTile((int)this.x, (int)(this.y + 0.12F), (int)this.z)) != 0?Block.b[var1].d().equals(LiquidType.b):false;
   }

   public boolean isInLava() {
      return this.level.containsLiquid(this.bb.grow(0.0F, -0.4F, 0.0F), LiquidType.c);
   }

   public void moveRelative(float var1, float var2, float var3) {
      float var4;
      if((var4 = MathHelper.c(var1 * var1 + var2 * var2)) >= 0.01F) {
         if(var4 < 1.0F) {
            var4 = 1.0F;
         }
         ...
         var1 *= var4;
         var2 *= var4;
         var3 = MathHelper.a(this.yRot * 3.1415927F / 180.0F);
         var4 = MathHelper.b(this.yRot * 3.1415927F / 180.0F);
   ...
   public float distanceTo(float var1, float var2, float var3) {
      ...
      return MathHelper.c(var1 * var1 + var2 * var2 + var4 * var4);
   }
   ...
   public boolean shouldRender(Vec3D var1) {
      float var2 = this.x - var1.a;
      float var3 = this.y - var1.b;
      float var4 = this.z - var1.c;
