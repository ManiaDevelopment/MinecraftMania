...
public class AABB implements Serializable {
   ...
   public boolean contains(Vec3D var1) {
      return var1.a > this.x0 && var1.a < this.x1?(var1.b > this.y0 && var1.b < this.y1?var1.c > this.z0 && var1.c < this.z1:false):false;
   }
   ...
   public MovingObjectPosition clip(Vec3D var1, Vec3D var2) {
      Vec3D var3 = var1.a(var2, this.x0);
      Vec3D var4 = var1.a(var2, this.x1);
      Vec3D var5 = var1.b(var2, this.y0);
      Vec3D var6 = var1.b(var2, this.y1);
      Vec3D var7 = var1.c(var2, this.z0);
      var2 = var1.c(var2, this.z1);
      if(!this.a(var3)) {
         var3 = null;
      }
      ...
      if(var4 != null && (var8 == null || var1.c(var4) < var1.c(var8))) {
         var8 = var4;
      }

      if(var5 != null && (var8 == null || var1.c(var5) < var1.c(var8))) {
         var8 = var5;
      }

      if(var6 != null && (var8 == null || var1.c(var6) < var1.c(var8))) {
         var8 = var6;
      }

      if(var7 != null && (var8 == null || var1.c(var7) < var1.c(var8))) {
         var8 = var7;
      }

      if(var2 != null && (var8 == null || var1.c(var2) < var1.c(var8))) {
         var8 = var2;
      }
   ...
   private boolean a(Vec3D var1) {
      return var1 == null?false:var1.b >= this.y0 && var1.b <= this.y1 && var1.c >= this.z0 && var1.c <= this.z1;
   }

   private boolean b(Vec3D var1) {
      return var1 == null?false:var1.a >= this.x0 && var1.a <= this.x1 && var1.c >= this.z0 && var1.c <= this.z1;
   }

   private boolean c(Vec3D var1) {
      return var1 == null?false:var1.a >= this.x0 && var1.a <= this.x1 && var1.b >= this.y0 && var1.b <= this.y1;
   }
}
