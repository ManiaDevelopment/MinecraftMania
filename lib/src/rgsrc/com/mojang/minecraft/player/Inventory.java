...
public class Inventory implements Serializable {
   ...
   public void grabTexture(int var1, boolean var2) {
      int var3;
      if((var3 = this.a(var1)) >= 0) {
         this.selected = var3;
      } else {
         if(var2 && var1 > 0 && AvailableBlockType.a.contains(Block.b[var1])) {
            this.replaceSlot(Block.b[var1]);
         }
   ...
   public void replaceSlot(int var1) {
      if(var1 >= 0) {
         this.replaceSlot((Block)AvailableBlockType.a.get(var1));
      }
   ...
   public void replaceSlot(Block var1) {
      if(var1 != null) {
         int var2;
         if((var2 = this.a(var1.ac)) >= 0) {
            this.slots[var2] = this.slots[this.selected];
         }

         this.slots[this.selected] = var1.ac;
      }
